                        ...
                        <div class="contact-form">
                            <div id="success"></div>
                             <form  action="addStudentBack.php" method="post">
                                 ...
                                 data-validation-required-message="Please enter student name"
                                 name="studentName">
                                 <br>
                                 <input 
                                 type="text" 
                                 ...
                                 required="required" 
                                 data-validation-required-message="Please enter student phone number"
                                 name="studentPhoneNumber">
                                 <br>
                                 <button class="btn" type="submit" id="sendMessageButton" name="submit">Add Student</button>
...
<!--                                    <a href="">FQAs</a>-->
            ...
            <div class="container copyright">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p>Designed By <a href="https://www.linkedin.com/in/siddharth-saxena-2295281b0/"></a></p>
                    </div>
                </div>
            </div>
        </div>
