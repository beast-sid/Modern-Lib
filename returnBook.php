<?php
   ...
   where bookId='$bookId' and stock='$stock'"),MYSQLI_NUM);

   if(count($book)==0){
        ?>
         <Script>
            alert("Book has not been issued");
            window.location.href = 'returnBookFront.php';
         </Script>
       <?php
       exit();
                ...
                <div class="section-header">
                    ...
                    <div class="col-md-7" >
                        <div class="contact-form">
                            <div id="success"></div>
                             <form  action="returnBookBack.php" method="post" >
                                 ...
                                 name="studentId">
                                 <br>
                                 <button class="btn" type="submit" id="sendMessageButton" name="submit">Return Book</button>
