...
<html lang="en">
  ...
  <input type="search" placeholder="Enter the bookId" id="gsearch" name="gsearch">
                <button onclick="search()" >Search</button>
                <script>
                    
                    function search(){
                        var id=document.getElementById("gsearch").value;
                        window.location.href = "returnBook.php?id="+id;
                    }
                                    ...
                                    ?>
                                      <tr>
                                            ...
                                            <td><?php echo $row[1] ?></td>
                                             <td>
                                                <a href="returnBook.php?id=<?php echo $row[0]?>">
                                                    RETURN THIS
                                                </a>
                                            </td>
                                      </tr>
